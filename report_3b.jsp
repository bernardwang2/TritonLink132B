<html>
<HEAD><TITLE>CSE132B Webapp: Report 3b</TITLE></HEAD>
<BODY>  <FONT SIZE="5">Report 3b</FONT> <P />
...
<table>
    ...
    <tr>
        <td>
            <table>
                <form action="report_3b.jsp" method="POST">
...
%>
    ...
    <tr>
        <td>
            Professor <%= selected_professor %> gave the following grades to the students taking course <%= selected_course %>
        </td>
    </tr>
